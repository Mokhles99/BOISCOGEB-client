...
const thirdImageUrl = abouts.length > 2 && abouts[2].files.length > 0
  ...
  : '';
  // Log de l'état complet dans la console
  // console.log("État complet :", state);
  // console.log("aziz:", abouts);
  ...
  >
    Fondée en 1980, COGEB se spécialise dans la vente de bois et dérivés.
    Leader dans ce domaine, elle propose divers produits, répondant aux
    ...
    <div className="bg-white shadow-2xl px-4 py-6 rounded-3xl flex items-center gap-x-3 lg:w-4/5 mt-6">
      ...
      <div className="lg:w-1/2 flex items-end gap-4 lg:mt-0 mt-12 lg:h-auto h-[40rem]">
        ...
        <div className="w-1/2 h-4/5 flex flex-col gap-4 relative -top-20">
          <img
            // src="/assets/nvlproposbois 1.png"
          ...
          />
          <img
            // src="/assets/nvlproposbois2 1.png"
            // src={thirdImageUrl}
            src={thirdImageUrl ||"/assets/nvlproposbois2 1.png"}
            alt=""
            className="w-full h-2/5 rounded-3xl shadow-md object-cover"
          />
          {/* <button className="bg-gradient-to-r from-[#C0A26C] to-[#eff9f9] rounded-full h-12 w-12 cursor-auto absolute -bottom-12 left-16"></button> */}
        </div>
      </div>
